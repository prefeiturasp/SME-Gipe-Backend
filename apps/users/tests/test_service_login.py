...
class TestAutenticacaoService:
    ...
    @patch("apps.users.services.login.env")
    @patch("apps.users.services.login.requests.post")
    ...
    @patch("apps.users.services.login.env")
    @patch("apps.users.services.login.requests.post", side_effect=Exception("Erro inesperado"))
    ...
    @patch("apps.users.services.login.env")
    @patch("apps.users.services.login.requests.post", side_effect=Exception("Falha de rede"))
    ...
    @patch("apps.users.services.login.env")
    @patch("apps.users.services.login.requests.post", side_effect=requests.exceptions.RequestException("Timeout"))
...
class TestAuthenticateUserByCPF:
    ...
    @patch("apps.users.services.login.User")
    @patch("apps.users.services.login.RefreshToken")
    ...
    @patch("apps.users.services.login.User.objects.get")
